...
namespace SystemOfEquations
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            progressBar1.Enabled = true;
            progressBar1.Value = 0;
            backgroundWorker1.RunWorkerAsync(new object[] { mutationType, mutationRateStart, mutationRateEnd, historySize, anzahlGenerationen, anzahlKinder, rekombinationsPunkte, selectionStrategie });
        }

        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            m_Generator.generateNewGenerations(backgroundWorker1, (MutationType)(int)((object[])e.Argument)[0], (int)((object[])e.Argument)[1], (int)((object[])e.Argument)[2], (int)((object[])e.Argument)[3], (int)((object[])e.Argument)[4], (int)((object[])e.Argument)[5], (int)((object[])e.Argument)[6], (int)((object[])e.Argument)[7]);
        }
